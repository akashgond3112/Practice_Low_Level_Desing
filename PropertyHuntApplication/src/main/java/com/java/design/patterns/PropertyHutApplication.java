...
import com.java.design.patterns.enums.ListingType;
import com.java.design.patterns.enums.RoomType;
import com.java.design.patterns.service.PropertyHuntService;
import com.java.design.patterns.service.PropertyHuntServiceImpl;
...
public class PropertyHutApplication {
	public static void main(String[] args) {
		...
		//list property (2 api)
		propertyHuntService.listProperty("112", "A 3BHK for sale", "bellandur", "90L", ListingType.SELL, "1800sq",
				RoomType.THREEBHK);

		propertyHuntService.listProperty("113", "A 2BHK for sale", "sarjapura", "40k", ListingType.RENT, "1500sq",
				RoomType.TWOBHK);
		...
		propertyHuntService.listProperty("154", "A 3BHK for sale3", "bellandur", "90L", ListingType.SELL, "1800sq",
				RoomType.THREEBHK);
