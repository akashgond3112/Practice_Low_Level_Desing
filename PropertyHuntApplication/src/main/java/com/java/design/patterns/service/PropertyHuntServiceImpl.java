...
import com.java.design.patterns.UI.PropertyHutDisplay;
import com.java.design.patterns.Util.SearchPropertyUtil;
import com.java.design.patterns.dao.PropertyHuntDao;
import com.java.design.patterns.enums.ListingType;
import com.java.design.patterns.enums.RoomType;
import com.java.design.patterns.models.Property;
...
public class PropertyHuntServiceImpl implements PropertyHuntService {
	...
	public void listProperty(String propertyID, String propertyTitle, String location, String price,
			ListingType listingType, String propertySize, RoomType roomType) {
