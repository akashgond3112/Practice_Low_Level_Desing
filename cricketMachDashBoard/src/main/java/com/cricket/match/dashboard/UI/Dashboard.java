package com.cricket.match.dashboard.UI;

import com.cricket.match.dashboard.models.CricketPlayer;
import com.cricket.match.dashboard.models.PlayerData;
...
public class Dashboard {
	...
	private void displayTeamStats(Team currentTeam) {
		for (CricketPlayer player : currentTeam.getPlayers()) {
			...
			System.out.println(
					player.getPlayerName() + "          | " + data.getScore() + " | " + data.getNumberOfFour() + " | " + data.getNumberOfSix() + " | " + data.getNumberOfBallsFaced());
		}
	}
