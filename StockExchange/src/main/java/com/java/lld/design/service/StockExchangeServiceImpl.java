...
import com.java.lld.design.constants.OrderType;
import com.java.lld.design.dao.StockExchangeDao;
import com.java.lld.design.model.BuyOrder;
import com.java.lld.design.model.OrderFactory;
import com.java.lld.design.model.SellOrder;
import com.java.lld.design.ui.ExecuteOrders;
...
public class StockExchangeServiceImpl implements StockExchangeService {
	...
	public void addSellOrder(String orderId, String stockName, Double price, int quantity, LocalTime time) {
		SellOrder order = (SellOrder) OrderFactory.getOrder(OrderType.SELL_ORDER, orderId, stockName, price, quantity,
				time);
	...
	public void matchAndExecuteBuyOrder(String orderId, String stockName, Double price, int quantity, LocalTime time) {
		BuyOrder order = (BuyOrder) OrderFactory.getOrder(OrderType.BUY_ORDER, orderId, stockName, price, quantity,
				time);
		executeOrder(order);
